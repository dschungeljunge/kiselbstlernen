/**
 * Step 1 – Erstes Video der Weiterbildung
 * 
...
export default function Step1Page(props: PageProps<"/step/1">) {
  use(props.params);
      ...
      <main className="mx-auto w-full max-w-4xl pb-16 pt-14">
        ...
        <div className="relative w-full overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm">
          <div style={{ position: "relative", paddingBottom: "56.25%", height: 0 }}>
            <iframe
              src="https://www.loom.com/embed/a9bd95bbac49413d87e1501024a36ba7"
              frameBorder="0"
              allowFullScreen
              style={{
                position: "absolute",
